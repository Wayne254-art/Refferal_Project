...
const Verification = () => {
  ...
  return (
    ...
    <div className="proceed-form-container">
        <form>
            <h4 style={{ display: 'flex', justifyContent: 'center',marginBottom:'10px' }}>Confirm Your Payment Status to Continue</h4>
            ...
            <button type="button">Continue</button>
             <Link to={`/payment/${user.userId}`} className="signup-link" style={{marginTop:'20px'}}>Make Payment</Link>
        </form>
    </div>
    </div>
);
